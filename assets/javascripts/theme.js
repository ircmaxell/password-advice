(function() {
    ...
    $('ul').each(function() {
        ...
        self.children('li').each(function() {
            ...
            group.append($('<div class="accordion-heading"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-' + blockId + '" href="#accordion-' + itemId + '">' + item.find('h1:first').text() + '</a></div>'));
